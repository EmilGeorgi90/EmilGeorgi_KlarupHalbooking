...
{
    /// <summary>
    /// Interaction logic for TimePickerExtention.xaml
    /// </summary>
    public partial class TimePickerExtention : UserControl, INotifyPropertyChanged
    {
    ...
    = DependencyProperty.Register(
          "SelectedTime", typeof(string), typeof(TimePickerExtention),
